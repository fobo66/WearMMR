...
class MatchmakingRatingWatchFace : CanvasWatchFaceService() {
  ...
  inner class Engine : CanvasWatchFaceService.Engine() {
    ...
    override fun onCreate(holder: SurfaceHolder) {
      ...
      setWatchFaceStyle(WatchFaceStyle.Builder(this@MatchmakingRatingWatchFace)
          .setAcceptsTapEvents(true)
          .build())

      setActiveComplications(SystemProviders.WATCH_BATTERY, RATING_PROVIDER_ID)
      setDefaultComplicationProvider(SystemProviders.WATCH_BATTERY,
          SystemProviders.batteryProvider(), TYPE_SHORT_TEXT)
      setDefaultComplicationProvider(RATING_PROVIDER_ID,
      ...
      mTextPaint = Paint().apply {
        typeface = ResourcesCompat.getFont(this@MatchmakingRatingWatchFace, R.font.trajan_pro)
        isAntiAlias = true
    ...
    override fun onSurfaceChanged(holder: SurfaceHolder?, format: Int, width: Int, height: Int) {
      ...
      val batteryComplicationBounds = Rect(horizontalOffset,
          verticalOffset,
      ...
      val ratingComplicationBounds = Rect((midpointOfScreen + horizontalOffset),
          verticalOffset,
    ...
    override fun onDraw(canvas: Canvas, bounds: Rect) {
      ...
      if (modeAmbient) {
        ...
        val bgBitmap: Bitmap = (resources.getDrawable(R.drawable.dota_logo,
