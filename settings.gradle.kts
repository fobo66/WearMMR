...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("libs") {
            ...
            plugin("ksp", "com.google.devtools.ksp").version("2.0.21-1.0.26")
            ...
            library("desugar", "com.android.tools:desugar_jdk_libs:2.1.2")
            library(
                "coroutines",
        ...
        register("compose") {
            ...
            library("material", "androidx.compose.material3:material3:1.3.0")
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha27")
        ...
        register("androidx") {
            ...
            library("constraint", "androidx.constraintlayout:constraintlayout:2.2.0-rc01")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:33.5.0")
