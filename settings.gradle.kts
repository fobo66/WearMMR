...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("koin") {
            ...
            library("compose", "io.insert-koin:koin-androidx-compose:3.5.4")
        }

        register("compose") {
            version("compiler", "1.5.12")
            version("regular", "1.6.4")
            version("wear", "1.4.0-alpha07")
            ...
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha21")
        ...
        register("androidx") {
            ...
            version("lifecycle", "2.8.0-alpha03")
            library("core", "androidx.core:core-ktx:1.13.0")
            library("activity", "androidx.activity:activity-compose:1.9.0-rc01")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:32.8.1")
