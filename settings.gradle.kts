...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("compose") {
            ...
            version("regular", "1.5.0-alpha03")
            version("wear", "1.2.0-alpha09")
            ...
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha03")
        ...
        register("androidx") {
            library("wear", "androidx.wear:wear:1.3.0-alpha05")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:32.0.0")
