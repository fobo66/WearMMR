...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("compose") {
            ...
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha05")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:32.1.0")
