...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("compose") {
            ...
            library("material", "androidx.compose.material3:material3:1.2.0")
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha17")
        ...
        register("androidx") {
            ...
            library("activity", "androidx.activity:activity-compose:1.9.0-alpha02")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:32.7.1")
