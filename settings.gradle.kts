...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("koin") {
            library("core", "io.insert-koin:koin-android:3.4.2")
            library("compose", "io.insert-koin:koin-androidx-compose:3.4.5")
        }
        ...
        register("compose") {
            ...
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha06")
        ...
        register("androidx") {
            library("wear", "androidx.wear:wear:1.3.0-beta01")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:32.2.0")
            plugin("crashlytics", "com.google.firebase.crashlytics").version("2.9.7")
