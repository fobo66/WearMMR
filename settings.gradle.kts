...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("koin") {
            library("core", "io.insert-koin:koin-android:3.5.6")
            library("compose", "io.insert-koin:koin-androidx-compose:3.5.6")
        }

        register("compose") {
            version("regular", "1.6.8")
            version("wear", "1.4.0-beta03")
            ...
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha23")
        ...
        register("androidx") {
            ...
            library("uitest.core", "androidx.test:core-ktx:1.6.0-rc01")
            library("uitest.junit", "androidx.test.ext:junit-ktx:1.2.0-rc01")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:33.1.0")
            plugin("crashlytics", "com.google.firebase.crashlytics").version("3.0.1")
