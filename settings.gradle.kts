...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("compose") {
            ...
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha32")
        ...
        register("androidx") {
            ...
            library("wear.phoneinteraction", "androidx.wear:wear-phone-interactions:1.1.0-beta01")
        ...
        register("firebase") {
            ...
            plugin("crashlytics", "com.google.firebase.crashlytics").version("3.0.3")
