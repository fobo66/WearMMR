...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("libs") {
            ...
            plugin("ksp", "com.google.devtools.ksp").version("1.8.20-1.0.11")
        ...
        register("koin") {
            library("core", "io.insert-koin:koin-android:3.4.0")
            library("compose", "io.insert-koin:koin-androidx-compose:3.4.4")
        }

        register("compose") {
            version("compiler", "1.4.5")
            version("regular", "1.5.0-alpha02")
            version("wear", "1.2.0-alpha08")
            ...
            library("material", "androidx.compose.material3:material3:1.1.0-beta02")
            library("material3", "androidx.wear.compose:compose-material3:1.0.0-alpha02")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:31.4.0")
