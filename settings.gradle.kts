...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        register("compose") {
            ...
            library("material", "androidx.compose.material3:material3:1.1.0-alpha06")
        ...
        register("firebase") {
            library("bom", "com.google.firebase:firebase-bom:31.2.1")
